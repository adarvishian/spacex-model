...
/** FRONTEND_PRD §8.3 — minimap updates within 100ms of cell click (client-side). */
test("minimap updates quickly after keyboard cell move", async ({ page }) => {
  ...
  await page.getByLabel("Model minimap").locator(".lifecycle-block .stage.active").waitFor();
